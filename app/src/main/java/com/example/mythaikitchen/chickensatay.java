...
public class chickensatay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chickensatay);
        ...
        chicken.setOnClickListener(new View.OnClickListener() {
            @Override
            //checking whether the user has inputted a meat selection
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count == 2){
                    if (chickencheck == false){
                        Toast.makeText(chickensatay.this, "Select Meat", Toast.LENGTH_SHORT).show();
                    }else {
                        updateStock();
                        saveFood1();
                        openHome();
                    ...
                    Toast.makeText(chickensatay.this, "Press again to confirm", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void updateStock() {
        ...
        DatabaseReference dayRef = stockRef.child("wednesday");
        DatabaseReference foodRef = dayRef.child("food1 chicken satay");
    ...
    private void retrieveStock() {
        ...
        dayRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                stockSnapshot = snapshot.child("food1 chicken satay").getValue(String.class);

...
public class rice extends AppCompatActivity {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count == 2){
                    ...
                    Toast.makeText(rice.this, "Press again to confirm", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void updateStock() {
        ...
        DatabaseReference foodRef = dayRef.child("food5 rice");
    ...
    private void retrieveStock() {
        ...
        dayRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                stockSnapshot = snapshot.child("food5 rice").getValue(String.class);
    ...
    private void saveFood5() {
        SharedPreferences food5 = getSharedPreferences("food5", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = food5.edit();
        editor.putString("COST5", costString);
        editor.putString("QUANTITY5", quantityString);
        editor.apply();
    }

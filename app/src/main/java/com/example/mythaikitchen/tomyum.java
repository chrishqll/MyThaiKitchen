...
public class tomyum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tomyum);
        ...
        shrimp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (shrimpcheck == false){
                    shrimpcheck = true;
                    shrimp.setBackgroundResource(R.drawable.chicken);
                    meatChoice = "shrimp";
                }
                else {
                    shrimpcheck = false;
                    shrimp.setBackgroundResource(R.drawable.chickenfade);
                    meatChoice = "default";
                }
            }
        });
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count == 2){
                    if (shrimpcheck == false){
                        Toast.makeText(tomyum.this, "Select Meat", Toast.LENGTH_SHORT).show();
                    }else {
                        updateStock();
                        saveFood2();
                        openHome();
                    ...
                    Toast.makeText(tomyum.this, "Press again to confirm", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void updateStock() {
        ...
        DatabaseReference foodRef = dayRef.child("food2 tom yum");
    ...
    private void retrieveStock() {
        ...
        dayRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                stockSnapshot = snapshot.child("food2 tom yum").getValue(String.class);

...
public class springrolls extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_springrolls);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (count == 2){
                    ...
                    Toast.makeText(springrolls.this, "Press again to confirm", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void updateStock() {
        ...
        DatabaseReference foodRef = dayRef.child("food6 spring rolls");
    ...
    private void retrieveStock() {
        ...
        dayRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                stockSnapshot = snapshot.child("food6 spring rolls").getValue(String.class);
    ...
    private void saveFood6() {
        SharedPreferences food6 = getSharedPreferences("food6", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = food6.edit();
        editor.putString("COST6", costString);
        editor.putString("QUANTITY6", quantityString);
        editor.apply();
    }

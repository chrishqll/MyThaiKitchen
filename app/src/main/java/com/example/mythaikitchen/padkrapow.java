...
public class padkrapow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_padkrapow);
            ...
            public void onClick(View v) {
                ...
                if (count == 2){
                    if (chickencheck == false && porkcheck == false && beefcheck == false){
                        Toast.makeText(padkrapow.this, "Select Meat", Toast.LENGTH_SHORT).show();
                    }else {
                        updateStock();
                        saveFood3();
                        openHome();
                    ...
                    Toast.makeText(padkrapow.this, "Press again to confirm", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void updateStock() {
        ...
        DatabaseReference dayRef = stockRef.child("thursday");
        DatabaseReference foodRef = dayRef.child("food3 pad krapow");
    ...
    private void retrieveStock() {
        ...
        dayRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                stockSnapshot = snapshot.child("food3 pad krapow").getValue(String.class);
    ...
    private void saveFood3() {
        SharedPreferences food3= getSharedPreferences("food3", Context.MODE_PRIVATE);
        SharedPreferences.Editor editor = food3.edit();
        editor.putString("COST3", costString);
        editor.putString("QUANTITY3", quantityString);
        editor.putString("MEAT3", meatChoice);
        editor.apply();
    }

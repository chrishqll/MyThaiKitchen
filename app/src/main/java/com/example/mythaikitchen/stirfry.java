...
public class stirfry extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                if (count == 2){
                    if (chickencheck == false && porkcheck == false && beefcheck == false){
                        Toast.makeText(stirfry.this, "Select Meat", Toast.LENGTH_SHORT).show();
                    }else {
                        updateStock();
                        saveFood2();
                        openHome();
                    ...
                    Toast.makeText(stirfry.this, "Press again to confirm", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void updateStock() {
        ...
        DatabaseReference foodRef = dayRef.child("food2 stir fry");
    ...
    private void retrieveStock() {
        ...
        dayRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                stockSnapshot = snapshot.child("food2 stir fry").getValue(String.class);
